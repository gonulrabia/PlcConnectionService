...
namespace PlcConnectionService
{
    ...
    {      
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            {
                _logger.LogError(DateTime.Now + " ==> ExecuteAsync(). Hata: " + ex.Message);
            }
        }
        ...
        private bool OpenConnection()
        {
            try
            {
                ...
                else
                {
                    ...
                    _logger.LogError(DateTime.Now + " ==> PLC ile baðlantý kurulamadý.");
                    Console.WriteLine(DateTime.Now + $"Hata Kodu: {errorCode}, Hata Ýletisi: {errorMessage}");
                    _logger.LogError(DateTime.Now + $"Hata Kodu: {errorCode}, Hata Ýletisi: {errorMessage}");
                    plc.Close();
                    return false;
                }
            }
            ...
            try
            {
                ...
                if (raporVar == 0)
                {
                    ...
                    if (timeOutSeconds >= 4)
                    {
                        ...
                        _logger.LogError(DateTime.Now + " ==> Baðlantý Koptu.");
                        plc.Close();
                    ...
                    else
                    {
                        ...
                        _logger.LogWarning(DateTime.Now + " ==> Rapor Yok.");
                    }
        ...
        private void SaveToSql()
        {
            try
            {
                ...
                using (var scope = _serviceScopeFactory.CreateScope())
                {
                    ...
                    Console.WriteLine(DateTime.Now + " ==> Veriler SQL'e baþarýyla eklendi.");
                    _logger.LogWarning(DateTime.Now + " ==> Veriler SQL'e baþarýyla eklendi.");
                }
            }
            catch (Exception ex)
            {
